...
public class NaverMap implements ActionListener{
	...
	Project01_F naverMap; //Project10_F 타입 변수 선언
	public NaverMap(Project01_F naverMap) { //인자로 받은 naverMap 을 naverMap맴버에 저장.
		...
		String URL_STATICMAP = "https://naveropenapi.apigw.ntruss.com/map-static/v2/raster?";
     	try {
            ...
            if(responseCode==200) { //에러 없을시.
                ...
                //데이터 내보내기. -> 1024바이트씩 버퍼하여 read에 저장.
